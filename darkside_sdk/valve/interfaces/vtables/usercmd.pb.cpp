...
PROTOBUF_CONSTEXPR c_subtick_move_step::c_subtick_move_step(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
...
const uint32_t TableStruct_usercmd_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  1,
  2,
  PROTOBUF_FIELD_OFFSET(::c_subtick_move_step, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::c_subtick_move_step, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::c_subtick_move_step, _impl_.button_),
  PROTOBUF_FIELD_OFFSET(::c_subtick_move_step, _impl_.pressed_),
  PROTOBUF_FIELD_OFFSET(::c_subtick_move_step, _impl_.when_),
  PROTOBUF_FIELD_OFFSET(::c_subtick_move_step, _impl_.analog_forward_delta_),
  PROTOBUF_FIELD_OFFSET(::c_subtick_move_step, _impl_.analog_left_delta_),
  0,
  1,
  2,
  3,
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 12, 23, -1, sizeof(::c_subtick_move_step)},
...
class c_subtick_move_step::_Internal {
 public:
  using HasBits = decltype(std::declval<c_subtick_move_step>()._impl_._has_bits_);
...
c_subtick_move_step::c_subtick_move_step(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:CSubtickMoveStep)
}
c_subtick_move_step::c_subtick_move_step(const c_subtick_move_step& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  c_subtick_move_step* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
...
inline void c_subtick_move_step::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
c_subtick_move_step::~c_subtick_move_step() {
...
inline void c_subtick_move_step::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void c_subtick_move_step::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void c_subtick_move_step::Clear() {
...
const char* c_subtick_move_step::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
...
uint8_t* c_subtick_move_step::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
size_t c_subtick_move_step::ByteSizeLong() const {
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData c_subtick_move_step::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    c_subtick_move_step::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*c_subtick_move_step::GetClassData() const { return &_class_data_; }


void c_subtick_move_step::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<c_subtick_move_step*>(&to_msg);
  auto& from = static_cast<const c_subtick_move_step&>(from_msg);
...
void c_subtick_move_step::CopyFrom(const c_subtick_move_step& from) {
...
bool c_subtick_move_step::IsInitialized() const {
  return true;
}

void c_subtick_move_step::InternalSwap(c_subtick_move_step* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(c_subtick_move_step, _impl_.analog_left_delta_)
      + sizeof(c_subtick_move_step::_impl_.analog_left_delta_)
      - PROTOBUF_FIELD_OFFSET(c_subtick_move_step, _impl_.button_)>(
          reinterpret_cast<char*>(&_impl_.button_),
          reinterpret_cast<char*>(&other->_impl_.button_));
}

::PROTOBUF_NAMESPACE_ID::Metadata c_subtick_move_step::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_usercmd_2eproto_getter, &descriptor_table_usercmd_2eproto_once,
...
template<> PROTOBUF_NOINLINE ::c_subtick_move_step*
Arena::CreateMaybeMessage< ::c_subtick_move_step >(Arena* arena) {
  return Arena::CreateMessageInternal< ::c_subtick_move_step >(arena);
}
