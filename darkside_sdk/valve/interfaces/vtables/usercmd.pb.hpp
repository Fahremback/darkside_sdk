...
template<> ::c_subtick_move_step* Arena::CreateMaybeMessage<::c_subtick_move_step>(Arena*);
...
class c_subtick_move_step final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CSubtickMoveStep) */ {
 public:
  inline c_subtick_move_step() : c_subtick_move_step(nullptr) {}
  ~c_subtick_move_step() override;
  explicit PROTOBUF_CONSTEXPR c_subtick_move_step(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  c_subtick_move_step(const c_subtick_move_step& from);
  c_subtick_move_step(c_subtick_move_step&& from) noexcept
    : c_subtick_move_step() {
    *this = ::std::move(from);
  }

  inline c_subtick_move_step& operator=(const c_subtick_move_step& from) {
    CopyFrom(from);
    return *this;
  }
  inline c_subtick_move_step& operator=(c_subtick_move_step&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const c_subtick_move_step& default_instance() {
    return *internal_default_instance();
  }
  static inline const c_subtick_move_step* internal_default_instance() {
    return reinterpret_cast<const c_subtick_move_step*>(
               &_CSubtickMoveStep_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(c_subtick_move_step& a, c_subtick_move_step& b) {
    a.Swap(&b);
  }
  inline void Swap(c_subtick_move_step* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(c_subtick_move_step* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  c_subtick_move_step* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<c_subtick_move_step>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const c_subtick_move_step& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const c_subtick_move_step& from) {
    c_subtick_move_step::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(c_subtick_move_step* other);
  ...
  protected:
  explicit c_subtick_move_step(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class CBaseUserCmdPB final :
 ...
 public:
  ...
  ::c_subtick_move_step* mutable_subtick_moves(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_subtick_move_step >*
      mutable_subtick_moves();
  private:
  const ::c_subtick_move_step& _internal_subtick_moves(int index) const;
  ::c_subtick_move_step* _internal_add_subtick_moves();
  public:
  const ::c_subtick_move_step& subtick_moves(int index) const;
  ::c_subtick_move_step* AddSubtickMoves();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_subtick_move_step >&
      subtick_moves() const;
 ...
 private:
  ...
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_subtick_move_step > subtick_moves_;
...
// optional uint64 button = 1;
inline bool c_subtick_move_step::_internal_has_button() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool c_subtick_move_step::has_button() const {
  return _internal_has_button();
}
inline void c_subtick_move_step::clear_button() {
  _impl_.button_ = uint64_t{0u};
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint64_t c_subtick_move_step::_internal_button() const {
  return _impl_.button_;
}
inline uint64_t c_subtick_move_step::button() const {
  // @@protoc_insertion_point(field_get:CSubtickMoveStep.button)
  return _internal_button();
}
inline void c_subtick_move_step::_internal_set_button(uint64_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.button_ = value;
}
inline void c_subtick_move_step::set_button(uint64_t value) {
  _internal_set_button(value);
  // @@protoc_insertion_point(field_set:CSubtickMoveStep.button)
}

// optional bool pressed = 2;
inline bool c_subtick_move_step::_internal_has_pressed() const {
  bool value = (_impl_._has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool c_subtick_move_step::has_pressed() const {
  return _internal_has_pressed();
}
inline void c_subtick_move_step::clear_pressed() {
  _impl_.pressed_ = false;
  _impl_._has_bits_[0] &= ~0x00000002u;
}
inline bool c_subtick_move_step::_internal_pressed() const {
  return _impl_.pressed_;
}
inline bool c_subtick_move_step::pressed() const {
  // @@protoc_insertion_point(field_get:CSubtickMoveStep.pressed)
  return _internal_pressed();
}
inline void c_subtick_move_step::_internal_set_pressed(bool value) {
  _impl_._has_bits_[0] |= 0x00000002u;
  _impl_.pressed_ = value;
}
inline void c_subtick_move_step::set_pressed(bool value) {
  _internal_set_pressed(value);
  // @@protoc_insertion_point(field_set:CSubtickMoveStep.pressed)
}

// optional float when = 3;
inline bool c_subtick_move_step::_internal_has_when() const {
  bool value = (_impl_._has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool c_subtick_move_step::has_when() const {
  return _internal_has_when();
}
inline void c_subtick_move_step::clear_when() {
  _impl_.when_ = 0;
  _impl_._has_bits_[0] &= ~0x00000004u;
}
inline float c_subtick_move_step::_internal_when() const {
  return _impl_.when_;
}
inline float c_subtick_move_step::when() const {
  // @@protoc_insertion_point(field_get:CSubtickMoveStep.when)
  return _internal_when();
}
inline void c_subtick_move_step::_internal_set_when(float value) {
  _impl_._has_bits_[0] |= 0x00000004u;
  _impl_.when_ = value;
}
inline void c_subtick_move_step::set_when(float value) {
  _internal_set_when(value);
  // @@protoc_insertion_point(field_set:CSubtickMoveStep.when)
}

// optional float analog_forward_delta = 4;
inline bool c_subtick_move_step::_internal_has_analog_forward_delta() const {
  bool value = (_impl_._has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool c_subtick_move_step::has_analog_forward_delta() const {
  return _internal_has_analog_forward_delta();
}
inline void c_subtick_move_step::clear_analog_forward_delta() {
  _impl_.analog_forward_delta_ = 0;
  _impl_._has_bits_[0] &= ~0x00000008u;
}
inline float c_subtick_move_step::_internal_analog_forward_delta() const {
  return _impl_.analog_forward_delta_;
}
inline float c_subtick_move_step::analog_forward_delta() const {
  // @@protoc_insertion_point(field_get:CSubtickMoveStep.analog_forward_delta)
  return _internal_analog_forward_delta();
}
inline void c_subtick_move_step::_internal_set_analog_forward_delta(float value) {
  _impl_._has_bits_[0] |= 0x00000008u;
  _impl_.analog_forward_delta_ = value;
}
inline void c_subtick_move_step::set_analog_forward_delta(float value) {
  _internal_set_analog_forward_delta(value);
  // @@protoc_insertion_point(field_set:CSubtickMoveStep.analog_forward_delta)
}

// optional float analog_left_delta = 5;
inline bool c_subtick_move_step::_internal_has_analog_left_delta() const {
  bool value = (_impl_._has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool c_subtick_move_step::has_analog_left_delta() const {
  return _internal_has_analog_left_delta();
}
inline void c_subtick_move_step::clear_analog_left_delta() {
  _impl_.analog_left_delta_ = 0;
  _impl_._has_bits_[0] &= ~0x00000010u;
}
inline float c_subtick_move_step::_internal_analog_left_delta() const {
  return _impl_.analog_left_delta_;
}
inline float c_subtick_move_step::analog_left_delta() const {
  // @@protoc_insertion_point(field_get:CSubtickMoveStep.analog_left_delta)
  return _internal_analog_left_delta();
}
inline void c_subtick_move_step::_internal_set_analog_left_delta(float value) {
  _impl_._has_bits_[0] |= 0x00000010u;
  _impl_.analog_left_delta_ = value;
}
inline void c_subtick_move_step::set_analog_left_delta(float value) {
...
inline ::c_subtick_move_step* CBaseUserCmdPB::mutable_subtick_moves(int index) {
  // @@protoc_insertion_point(field_mutable:CBaseUserCmdPB.subtick_moves)
  return _impl_.subtick_moves_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_subtick_move_step >*
...
inline const ::c_subtick_move_step& CBaseUserCmdPB::_internal_subtick_moves(int index) const {
  return _impl_.subtick_moves_.Get(index);
}
inline const ::c_subtick_move_step& CBaseUserCmdPB::subtick_moves(int index) const {
  // @@protoc_insertion_point(field_get:CBaseUserCmdPB.subtick_moves)
  return _internal_subtick_moves(index);
}
inline ::c_subtick_move_step* CBaseUserCmdPB::_internal_add_subtick_moves() {
  return _impl_.subtick_moves_.Add();
}
inline ::c_subtick_move_step* CBaseUserCmdPB::AddSubtickMoves() {
  ::c_subtick_move_step* _add = _internal_add_subtick_moves();
  // @@protoc_insertion_point(field_add:CBaseUserCmdPB.subtick_moves)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::c_subtick_move_step >&
