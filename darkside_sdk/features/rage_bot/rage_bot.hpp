...
struct lag_record_t {
	...
	inline void store( c_cs_player_pawn* pawn ) {
		...
		static auto setup_bones = reinterpret_cast<void( __fastcall* )( void*, int )>( g_opcodes->scan_absolute( g_modules->m_modules.client_dll.get_name( ), "E8 ? ? ? ? 49 8B 96 ? ? ? ? 48 8B CE E8", 0x1 ) );
